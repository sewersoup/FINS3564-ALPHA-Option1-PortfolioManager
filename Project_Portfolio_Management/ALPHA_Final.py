...
* THIS IS A COMPILED FILE OF THE PORTFOLIO OPTIMISER AND SENTIMENT ANALYSIS *
"""
...
def scoreData(df, toScore):
    ...
    # Group by equity, then find the mean sentiment over all occurrences.
...
# Return the mean scores of all the sentiment scores
...
# Create a DataFrame of only the compound scores
...
def main():
    ...
    sentiment_analysis = equitiesSentiment('news_dump.json')
